...
if(!lineage?.compound||lineage.compound.formula!=='LEGADO + LEGADO') errors.push('Regra de Legado Composto ausente/incorreta.');
if(!lineage?.direct||lineage.direct.formula!=='DEUS + LEGADO') errors.push('Regra de Legado Direto ausente/incorreta.');
